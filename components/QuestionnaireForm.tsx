            ...
            <div className="bg-white/80 p-6 md:p-8 rounded-2xl border border-blue-100 shadow-sm mb-6 transition-all hover:shadow-md">
                ...
                <div className="grid grid-cols-12 gap-5">
                    <div className="col-span-12">
                        ...
                        <select name="situation_avant" value={formData.situation_avant} onChange={handleChange} className="w-full px-4 py-3 bg-white border rounded-xl text-base text-slate-800 transition-all focus:ring-4 focus:outline-none cursor-pointer border-slate-200 focus:border-blue-500 focus:ring-blue-500/10">
                    ...
                    {/* Yes/No Groups */}
                    {[
                        { label: "Déclare être inscrit(e) sur la liste des sportifs de haut niveau", name: "sportif_haut_niveau" },
                        { label: "Déclare avoir un projet de création ou de reprise d'entreprise", name: "projet_entreprise" },
                        { label: "Déclare bénéficier de la reconnaissance travailleur handicapé (RQTH)", name: "rqth" }
                    ].map((item) => (
                             ...
                             <div className="bg-slate-50/50 p-5 rounded-xl border border-slate-100">
                                ...
                                <div className="flex gap-3">
                                    <label className="relative cursor-pointer group flex-1">
                                        <input className="peer sr-only" type="radio" name={item.name} value="oui" checked={formData[item.name as keyof typeof formData] === 'oui'} onChange={handleChange} />
                                        <div className={`flex items-center gap-3 px-4 py-3 rounded-xl border transition-all ${formData[item.name as keyof typeof formData] === 'oui' ? 'bg-blue-50 border-blue-500 ring-1 ring-blue-500' : 'bg-white border-slate-200 hover:border-blue-300'}`}>
                                            <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${formData[item.name as keyof typeof formData] === 'oui' ? 'bg-blue-500 text-white' : 'bg-slate-100 text-slate-400'}`}>A</span>
                                            <span className="font-medium text-slate-700">Oui</span>
                                        </div>
                                    </label>
                                    <label className="relative cursor-pointer group flex-1">
                                        <input className="peer sr-only" type="radio" name={item.name} value="non" checked={formData[item.name as keyof typeof formData] === 'non'} onChange={handleChange} />
                                        <div className={`flex items-center gap-3 px-4 py-3 rounded-xl border transition-all ${formData[item.name as keyof typeof formData] === 'non' ? 'bg-blue-50 border-blue-500 ring-1 ring-blue-500' : 'bg-white border-slate-200 hover:border-blue-300'}`}>
                                            <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${formData[item.name as keyof typeof formData] === 'non' ? 'bg-blue-500 text-white' : 'bg-slate-100 text-slate-400'}`}>B</span>
            ...
            <div className="bg-white/80 p-6 md:p-8 rounded-2xl border border-blue-100 shadow-sm mb-6 transition-all hover:shadow-md">
                ...
                <div className="grid grid-cols-12 gap-5">
                    ...
                    <div className="col-span-12">
                        ...
                        <select name="intitule_diplome" value={formData.intitule_diplome} onChange={handleChange} className="w-full px-4 py-3 bg-white border rounded-xl text-base text-slate-800 transition-all focus:ring-4 focus:outline-none cursor-pointer border-slate-200 focus:border-blue-500 focus:ring-blue-500/10">
                            <option value="">Sélectionnez</option>
            ...
            <div className="bg-white/80 p-6 md:p-8 rounded-2xl border border-blue-100 shadow-sm mb-6 transition-all hover:shadow-md">
                ...
                <div className="grid grid-cols-12 gap-5">
                    <div className="col-span-12">
                        ...
                        <select name="formation" value={formData.formation} onChange={handleChange} className="w-full px-4 py-3 bg-white border rounded-xl text-base text-slate-800 transition-all focus:ring-4 focus:outline-none cursor-pointer border-slate-200 focus:border-blue-500 focus:ring-blue-500/10">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <input className="w-full px-4 py-3 bg-white border rounded-xl text-base text-slate-800 placeholder:text-slate-400 transition-all focus:ring-4 focus:outline-none border-slate-200 focus:border-blue-500 focus:ring-blue-500/10" type="date" name="date_visite" value={formData.date_visite} onChange={handleChange} />
                    </div>
                    <div className="col-span-12 md:col-span-6">
                        <label className="block text-sm font-semibold text-slate-700 mb-2">Date d'envoi du règlement </label>
                        <input className="w-full px-4 py-3 bg-white border rounded-xl text-base text-slate-800 placeholder:text-slate-400 transition-all focus:ring-4 focus:outline-none border-slate-200 focus:border-blue-500 focus:ring-blue-500/10" type="date" name="date_reglement" value={formData.date_reglement} onChange={handleChange} />
                    </div>
                    <div className="col-span-12">
                        ...
                        <div className="flex gap-3 flex-wrap">
                            {['Oui', 'En recherche', 'Non'].map((val, idx) => (
                                <label key={val} className="relative cursor-pointer group flex-1 min-w-[120px]">
                                    <input className="peer sr-only" type="radio" name="entreprise_accueil" value={val} checked={formData.entreprise_accueil === val} onChange={handleChange} />
                                    <div className={`flex items-center gap-3 px-4 py-3 rounded-xl border transition-all ${formData.entreprise_accueil === val ? 'bg-blue-50 border-blue-500 ring-1 ring-blue-500' : 'bg-white border-slate-200 hover:border-blue-300 hover:bg-slate-50'}`}>
                                        <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-colors ${formData.entreprise_accueil === val ? 'bg-blue-500 text-white' : 'bg-slate-100 text-slate-400'}`}>{String.fromCharCode(65 + idx)}</span>
                                        <span className="font-medium text-slate-600">{val}</span>
                                    </div>
                                </label>
                            ))}
            ...
            <div className="bg-white/80 p-6 md:p-8 rounded-2xl border border-blue-100 shadow-sm mb-6 transition-all hover:shadow-md">
                ...
                <div className="grid grid-cols-12 gap-5">
                    <div className="col-span-12">
                        ...
                        <select name="source" value={formData.source} onChange={handleChange} className="w-full px-4 py-3 bg-white border rounded-xl text-base text-slate-800 transition-all focus:ring-4 focus:outline-none cursor-pointer border-slate-200 focus:border-blue-500 focus:ring-blue-500/10">
                            <option value="">Sélectionnez</option>
