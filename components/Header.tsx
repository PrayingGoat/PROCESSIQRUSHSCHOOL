  ...
  return (
    <header className="h-[64px] bg-white border-b border-[#E2E8F0] sticky top-0 z-30 px-6 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-2">
        <div className={`header-tab ${activeModule === AppModule.ADMISSION ? 'active' : ''}`}>
        ...
        <div className={`header-tab ${activeModule === AppModule.COMMERCIAL ? 'active' : ''}`}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className={`header-tab ${activeModule === AppModule.RH ? 'active' : ''}`}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className={`header-tab ${activeModule === AppModule.STUDENT ? 'active' : ''}`}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
