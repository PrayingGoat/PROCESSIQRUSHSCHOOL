                                                ...
                                                <tr key={c.id} className="hover:bg-slate-50/50 transition-colors group">
                                                    ...
                                                    <td className="px-8 py-6">
                                                        <div className="flex items-center gap-2 text-slate-600 font-bold">
                                                            <MapPin size={16} className="text-slate-300" /> {c.ville}
                                                        </div>
                                                    </td>
                                                    <td className="px-8 py-6">
                                                        <div className="flex items-center gap-2 text-slate-600 font-bold">
                                                            <Phone size={16} className="text-slate-300" /> {c.telephone}
                                                        </div>
                                                    </td>
                                                    <td className="px-8 py-6">
                                                    ...
                                                    <td className="px-8 py-6">
                                                        <div className="flex justify-center gap-3 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-4 group-hover:translate-x-0">
                                                            <button onClick={() => handleViewDetails(c.id)} className="p-3 rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-rose-500 hover:border-rose-200 hover:shadow-lg transition-all duration-300">
                                                                <Eye size={20} />
                                                            </button>
                                                            <button onClick={() => handleEdit(c.id)} className="p-3 rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-rose-500 hover:border-rose-200 hover:shadow-lg transition-all duration-300">
                                                                <Edit size={20} />
                                                            </button>
                                        ...
                                        {filteredStudents.map((raw) => {
                                            ...
                                            return (
                                                <tr key={c.id} className="hover:bg-slate-50/50 transition-colors group">
                                                    ...
                                                    <td className="px-8 py-6">
                                                        <div className="flex justify-center gap-3 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-4 group-hover:translate-x-0">
                                                            <button onClick={() => handleViewDetails(c.id)} className="p-3 rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-indigo-600 hover:border-indigo-200 hover:shadow-lg transition-all duration-300">
                                                                <Eye size={20} />
                                                            </button>
                                                            <button onClick={() => handleEdit(c.id)} className="p-3 rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-indigo-600 hover:border-indigo-200 hover:shadow-lg transition-all duration-300">
                                                                <Edit size={20} />
                                                            </button>
                                                        </div>
                                                    </td>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                        ...
                        <div className="flex justify-between items-start mb-6">
                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-indigo-500/20 group-hover:scale-110 transition-transform"> <Users size={28} /> </div>
                        ...
                        <div className="text-slate-400 text-sm font-bold flex items-center gap-2"> <ArrowUpRight size={16} className="text-emerald-500" /> <span className="text-emerald-500">+12%</span> depuis le mois dernier </div>
                    </div>
                    <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-rose-500/5 rounded-full -mr-16 -mt-16 blur-2xl group-hover:bg-rose-500/10 transition-colors"></div>
                        <div className="flex justify-between items-start mb-6">
                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-rose-500 to-rose-600 flex items-center justify-center text-white shadow-lg shadow-rose-500/20 group-hover:scale-110 transition-transform"> <Users size={28} /> </div>
                        ...
                        <div className="text-slate-400 text-sm font-bold flex items-center gap-2">
                            <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden"> <div className="bg-rose-500 h-full rounded-full" style={{ width: `${(studentsToPlace.length / candidates.length) * 100}%` }}></div> </div>
                        </div>
                    </div>
                    <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                        ...
                        <div className="flex justify-between items-start mb-6">
                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center text-white shadow-lg shadow-emerald-500/20 group-hover:scale-110 transition-transform"> <CheckCircle2 size={28} /> </div>
                        ...
                        <div className="text-slate-400 text-sm font-bold flex items-center gap-2">
                            <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden"> <div className="bg-emerald-500 h-full rounded-full" style={{ width: `${(studentsPlaced.length / candidates.length) * 100}%` }}></div> </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-white rounded-[2.5rem] w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl border border-white/20 flex flex-col animate-in zoom-in-95 duration-300">
                        <div className="p-10 border-b border-slate-100 flex justify-between items-center bg-gradient-to-r from-slate-50 via-white to-slate-50 relative overflow-hidden">
                            ...
                            <div className="relative z-10 flex items-center gap-6">
                                <div className="w-20 h-20 rounded-[2rem] bg-gradient-to-br from-rose-500 to-rose-600 text-white flex items-center justify-center shadow-2xl shadow-rose-500/30 group-hover:scale-110 transition-transform duration-500"> <UserCircle size={40} /> </div>
                                <div>
                                    <h2 className="text-3xl font-black text-slate-800 tracking-tighter mb-1"> {isEditing ? "Modifier le profil" : "Détails de l'étudiant"} </h2>
                                    <div className="flex items-center gap-3">
                                        <span className="px-3 py-1 bg-rose-50 text-rose-600 rounded-full text-[10px] font-black uppercase tracking-wider border border-rose-100/50"> {isEditing ? "Édition en cours" : "Consultation"} </span>
                                        <p className="text-slate-400 font-bold text-sm"> {isEditing ? "Mise à jour des informations de profil" : "Informations complètes et suivi des documents"} </p>
                                    </div>
                                </div>
                            </div>
                            <button onClick={() => setIsModalOpen(false)} className="relative z-10 w-14 h-14 rounded-2xl bg-slate-100 text-slate-400 hover:bg-rose-50 hover:text-rose-500 hover:rotate-90 transition-all duration-300 flex items-center justify-center group"> <X size={28} strokeWidth={3} /> </button>
                        </div>
                            ...
                            {detailsLoading ? (
                                ...
                                <div className="space-y-8">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50/50 p-8 rounded-[2rem] border border-slate-100">
                                        ...
                                        <Select label="Formation" value={editForm.formation_souhaitee} onChange={(e) => setEditForm({ ...editForm, formation_souhaitee: e.target.value })} options={[{ value: "BTS MCO", label: "BTS MCO" }, { value: "BTS NDRC", label: "BTS NDRC" }, { value: "BACHELOR RDC", label: "BACHELOR RDC" }, { value: "TP NTC", label: "TP NTC" }]} />
                                        <div className="md:col-span-2"> <Input label="Entreprise d'accueil" value={editForm.entreprise_d_accueil} onChange={(e) => setEditForm({ ...editForm, entreprise_d_accueil: e.target.value })} placeholder="Non ou Nom de l'entreprise" /> </div>
                                    </div>
                                </div>
                            ) : selectedCandidate ? (
